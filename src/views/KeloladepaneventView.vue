  ...
  <div class="my-4 max-w-screen-md border px-4 shadow-xl sm:mx-4 sm:rounded-xl sm:px-4 sm:py-4 md:mx-auto">
    <div class="flex flex-col border-b py-4 sm:flex-row sm:items-start">
      <div class="shrink-0 mr-auto sm:py-3">
        ...
        <p class="text-sm text-gray-600">Edit Data</p>
      </div>
    ...
    <div class="flex flex-col gap-4 border-b py-4 sm:flex-row">
      ...
      <input placeholder="your.email@example.com" class="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1" />
    </div>
    <div class="flex flex-col gap-4 py-4  lg:flex-row">
      <div class="shrink-0 w-32  sm:py-4">
        <p class="mb-auto font-medium">Image</p>
        <p class="text-sm text-gray-600">Change Image</p>
      </div>
