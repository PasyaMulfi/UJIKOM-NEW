  ...
  <div class="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-900 md:flex-row md:border md:shadow-lg">
    ...
    <div class="mt-10 bg-blue-600 px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
      <div class="">
        ...
        <p class="mb-4">Senin – Kamis: 08:00 – 16:00</p>
        <p class="mb-4">Jumat: 08:00 - 15:00</p>
        <p class="mb-4">Weekend: Tutup</p>
        <p class="mb-4">
          Email:
          <a href="#" class="font-semibold underline">umkm@apps.io</a>
        </p>
        <p class="mb-4">
          Phone:
          <a href="#" class="font-semibold underline">+62 857 2429 1544</a>
        </p>
