        ...
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div>
            <div class="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
              <img src="https://smesta.kemenkopukm.go.id/storage/contents/news/PwZOt9GWFcQNFrr9d9mJfIkPWWHqZ1vuIayHYGg5.png" loading="lazy" alt="Photo by Martin Sanchez" class="h-full w-full object-cover object-center" />
            </div>
          </div>
