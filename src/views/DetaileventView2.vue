        ...
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div>
            <div class="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
              <img src="https://sahabatumkm.id/wp-content/uploads/2023/04/banner2-300x124.jpg" loading="lazy" alt="Photo by Martin Sanchez" class="h-full w-full object-cover object-center" />
            </div>
          </div>
